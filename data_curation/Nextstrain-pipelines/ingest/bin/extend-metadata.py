...
if __name__ == "__main__":
    ...
    result = pd.merge(metadata, clades, left_index=True, right_index=True, how="left")
    ...
    for gene in coordinates[args.virus_type]:
        ...
        def get_coverage(d):
            try:
                return coverage(
                    coordinates[args.virus_type][gene],
                    [int(d.alignmentStart), int(d.alignmentEnd)],
                )
            except:
